...
- WiFi AP with configuration site
  ...
  - Set time in seconds to go to sleep, wakes up with any buttons press (has to be pressed twice to sent the animation then)
- 10 second press of BOOT button (pin 0) factory resets the remote
